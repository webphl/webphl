            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-dark sm:p-[60px]">
                <h3 className="mb-3 text-center text-2xl font-bold text-black dark:text-white sm:text-3xl">
                  S'inscrire et créer votre Compte
                </h3>
                <p className="mb-11 text-center text-base font-medium text-body-color">
                  C'est totalement gratuit et très facile à réaliser
                </p>
                ...
                <div className="mb-8 flex items-center justify-center">
                  ...
                  <p className="w-full px-5 text-center text-base font-medium text-body-color">
                    Ou Connectez-vous à l'aide de votre e-mail
                  </p>
                  <span className="hidden h-[1px] w-full max-w-[60px] bg-body-color sm:block"></span>
                </div>
                <form>
                    ...
                    >
                      ...
                      <span>
                        ...
                        <a href="#0" className="text-primary hover:underline">
                          {" "}
                          Conditions Générales d'Utilisation (CGU) et les conditions Générales de Ventes (CGV){" "}
                        </a>
                        , et notre
                        <a href="#0" className="text-primary hover:underline">
                          {" "}
